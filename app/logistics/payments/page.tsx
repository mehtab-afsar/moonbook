...
import { ReceiptForm, type OpenDocument } from "@/features/logistics/components/ReceiptForm";
    ...
    <div className="space-y-10 p-8">
      <section className="space-y-6">
        <header>
          ...
          <p className="mt-1 text-[13.5px] text-ink-2">Money received.</p>
        </header>
      ...
      <section className="space-y-6">
        <header>
          ...
          <p className="mt-1 text-[13.5px] text-ink-2">Money paid out, including advances paid before a bill arrives.</p>
        </header>
