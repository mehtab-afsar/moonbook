...
/**
 * Overhead — fuel, tolls, salaries, rent — not tied to any one trip. The
 * `expenses` table is shared across every vertical (it references only
 * `parties`/`organisations`, both shared tables), so this reuses the exact
 * same table, API route and form the shared ledger uses; nothing here is
 * logistics-specific except which sidebar links to it.
 */
