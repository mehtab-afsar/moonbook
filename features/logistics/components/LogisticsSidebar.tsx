...
import { LayoutDashboard, FileText, Banknote, Truck, Users, LogOut } from "lucide-react";
...
const NAV = [
  ...
  { href: "/logistics/activities", label: "Trips & charges", icon: Truck },
  { href: "/logistics/documents", label: "Documents", icon: FileText },
  { href: "/logistics/payments", label: "Payments", icon: Banknote },
